...
export class MockDataGenerator {
   ...
   */
  private static createQuotationSession(): MockChatSession {
...
O orçamento foi salvo e está pronto para ser enviado. Posso ajudá-lo com mais alguma coisa?`,
   ...
   */
  private static createServiceRegistrationSession(): MockChatSession {
    const sessionId = uuidv4();
...
O serviço agora está disponível no seu catálogo. Como mais posso ajudá-lo?`,
   ...
   */
  private static createClientRegistrationSession(): MockChatSession {
    const sessionId = uuidv4();
...
A cliente agora está no seu sistema. Como mais posso ajudá-lo?`,
   ...
   */
  private static createGeneralInquirySession(): MockChatSession {
    const sessionId = uuidv4();
   ...
   */
  private static createHelpSession(): MockChatSession {
    const sessionId = uuidv4();
